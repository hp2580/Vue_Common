...
<template>
  <div class="content-body">
    <section class="section">
      ...
      <ul class="list-dot">
        <li>모바일 앱 접근성은(Mobile application Accessibility) 데스크톱, 태블릿, 모바일, 하이브리드 앱에 이르기까지 웹 기술을 통해 구현하는 모든 서비스가 이 가이드라인의 적용 대상입니다.</li>
        <li>
          이 가이드라인은 <a
            href="https://www.w3.org/TR/WCAG21/"
            target="_blank"
            title="WCAG 2.1"
          >WCAG 2.1</a>이 근간이며 가이드라인에서 설명하지 않거나 애매한 주제는 WCAG 2.1의 수준 A 항목과 AA 항목의 지침 및 평가 방법을 따라야 합니다. 오픈오브젝트 웹 접근성 가이드라인은 오픈오브젝트 고유의 콘텐츠에 대응하는 WCAG 2.1 가이드라인에 대한 이해를 돕고 손쉽게 평가할 수 있도록 소개한 것으로써 고객에게 웹 서비스를 제공하기 전 준수해야 할 최소한의 요구사항입니다.
        </li>
        <li>이 가이드라인은 웹 기술(HTML, CSS, JavaScript)에 대한 사전 지식을 요구합니다.</li>
      </ul>
    </section>
    <section class="section">
    ...
    <section class="section">
      ...
      <span>기대효과</span>
      <ul class="list-dot">
        <li>전맹 또는 상지 장애가 있는 사용자와 키보드를 선호하는 사용자의 탐색과 조작을 돕는다.</li>
      </ul>
      <ul class="list-dot">
        <li>저시력 사용자가 내용을 빠르게 인지할 수 있다.</li>
      </ul>
    ...
    <section class="section">
      ...
      <span>기대효과</span>
      <ul class="list-dot">
        <li>전맹 사용자가 링크 또는 버튼에 독립적으로 또는 순차적으로 접근하는 경우 링크 또는 버튼의 목적을 음성으로 전달할 수 있다.</li>
      </ul>
      <Prism
        html
        show
    ...
    <section class="section">
      ...
      <span>기대효과</span>
      <ul class="list-dot">
        <li>보조기기 사용자가 원하는 탐색 지점으로 빠르게 건너 뛸 수 있다.</li>
        <li>검색엔진이 올바를 페이지를 수집하도록 돕는다.</li>
        <li>유저 에이전트 확장 기능 사용자에게 문서 개요를 전달할 수 있다.</li>
      </ul>
      <Prism
        html
        show
    ...
    <section class="section">
      ...
      <span>기대효과</span>
      <ul class="list-dot">
        <li>보조기기가 폼 콘트롤에 독립적으로 접근했을 때 콘트롤에 대한 설명을 제공할 수 있다.</li>
      </ul>
      <Prism
        html
        show
    ...
    <section class="section">
      ...
      >
        {{ `
        <!-- X -->
        <div><span>...</span></div> // span 종료 태그 생략 오류.
